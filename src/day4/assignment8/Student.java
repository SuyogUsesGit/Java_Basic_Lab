...
public abstract class Student {
    ...
    public static void main(String[] args) {
        Student student = new Hostelite(); // abstract class cannot be instantiated
        ...
        if(!student.getResidentialStatus().equals("Hostelite")) {
            student = new DayScholar(student.getStudentId(), student.getStudentType(),
                                                    student.getStudentName(), student.getFeesPerMonth(),
                                                    "Test Address");
            student.calculateFees(12000);
            student.displayStudentDetails();
        } else {
            student = new Hostelite(student.getStudentId(), student.getStudentType(),
